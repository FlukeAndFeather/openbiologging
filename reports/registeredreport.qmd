...
We will test hypothesis **H2** using coefficient $\beta_s$. To quantify effect size, we will contrast posterior probabilities for aspatial and spatial sensor data (see [@fig-h3]).
