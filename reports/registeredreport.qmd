...
During the broad-scale review, a minimum of two reviewers collected high-level information for each of the 4,799 selected articles. At this stage, article relevance was confirmed, and articles that discussed topics outside of this review (e.g., biotelemetry, medical applications) were deemed unrelated. Reviewers noted if the article presented novel biologging data, and if not, additional high-level information from the article was omitted. Related articles presenting newly collected biologging data went under further review.

Related articles were categorized as either a study (i.e., new research), review, methods paper, perspective, or data release paper. Additional high-level information for related articles included information about the instrumented species, biologging device, and data use and availability. For the instrumented species, reviewers recorded if the animal was domesticated, captive, or part of a wild population. Reviewers also recorded if the associated habitat of the species was most regularly terrestrial, aquatic, or marine. For the device, reviewers noted the type of information that the biologger recorded. This was separated into three categories: location (e.g., GPS, Argos, geolocation, depth, altitude), intrinsic (e.g., accelerometer, magnetometer, gyroscope heart rate, Hall sensor, stomach temperature, neurological sensors, Pitot tubes, speed sensors, internal body temperature), and environment (e.g., ambient temperature, video, audio, salinity, fluorescence, proximity sensors to other tagged animals, light). Lastly, reviewers recorded information about the data used and/or collected in the article. It was noted if the article used external non-biologging data (e.g., publicly available sea surface temperatures across the study domain) for their analysis and if the article included a biologging data availability statement. At this time, it was only noted if some language about the biologging data's availability was included, and no other metrics were used to assess the data's findability, accessibility, interoperability, and/or reusability. The last piece of information recorded during the initial classification was if the text "conserv\*" appeared in the article, and specifically within the context of conservation.

The article type, instrumented species, biologging device, data use and availability, and conservation application data collected during the broad-scale review was used to ensure that a diverse and comprehensive pool of sample papers were selected for the fine-scale review.
